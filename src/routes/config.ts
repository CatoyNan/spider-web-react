...
const menus: {
    ...
    menus: [
        // 菜单相关路由
        { key: '/app/dashboard/index', title: '任务统计', icon: 'mobile', component: 'Dashboard' },
        { key: '/app/spiderScript/sciptEditor', title: '脚本管理', icon: 'mobile', component: 'ScriptEditor' },
        { key: '/app/spiderTask/', title: '任务发布', icon: 'mobile', component: 'SpiderTask' },
        { key: '/app/spiderScript/scriptShare', title: '脚本社区', icon: 'mobile', component: 'ScriptShare' },
        // {
        //     key: '/app/ui',
        //     title: 'UI',
        //     icon: 'scan',
